...
### Component Ablation on RGBT-CC

| Variant | R | M | Gate | BPL | G(0) | G(1) | G(2) | G(3) | RMSE |
|---|:---:|:---:|:---:|:---:|---:|---:|---:|---:|---:|
| Baseline |  |  |  |  | 13.60 | 18.16 | 22.65 | 31.38 | 23.73 |
| RW fusion only | ✓ |  |  |  | 12.07 | 16.41 | 20.55 | 27.38 | 19.74 |
| Mediator only |  | ✓ |  |  | 11.94 | 16.26 | 20.33 | 27.14 | 19.48 |
| Mediator + gate |  | ✓ | ✓ |  | 11.31 | 15.67 | 19.78 | 26.89 | 18.95 |
| BPL |  |  |  | ✓ | 12.51 | 18.07 | 22.56 | 30.50 | 22.96 |
| **Full** | ✓ | ✓ | ✓ | ✓ | **10.70** | **14.98** | **19.06** | **26.41** | **18.62** |

**R**, **M**, **Gate**, and **BPL** denote reliability-weighted fusion, mediator tokens, reliability gate, and Binary Preference Loss, respectively.

### Impact of Window Size

| Window Size | GAME(0) | GAME(1) | GAME(2) | GAME(3) | RMSE |
|---:|---:|---:|---:|---:|---:|
| 4 | 12.16 | 16.77 | 21.08 | 28.47 | 20.44 |
| **8** | **10.70** | **14.98** | **19.06** | **26.41** | **18.62** |
| 16 | 11.96 | 16.07 | 20.94 | 28.49 | 19.10 |

### Impact of Mediator Token Number

| Mediators | GAME(0) | GAME(1) | GAME(2) | GAME(3) | RMSE |
|---:|---:|---:|---:|---:|---:|
| 2 | 12.26 | 16.89 | 21.24 | 29.05 | 20.52 |
| **4** | **10.70** | **14.98** | **19.06** | **26.41** | **18.62** |
| 8 | 11.19 | 16.56 | 20.87 | 28.25 | 18.82 |
| 16 | 11.20 | 16.94 | 21.70 | 30.10 | 18.94 |

### Impact of BPL Weight

| BPL Weight | GAME(0) | GAME(1) | GAME(2) | GAME(3) | RMSE |
|---:|---:|---:|---:|---:|---:|
| 0.001 | 12.64 | 16.82 | 21.17 | 28.48 | 21.04 |
| **0.1** | **10.70** | **14.98** | **19.06** | **26.41** | **18.62** |
| 1 | 11.49 | 17.18 | 21.53 | 28.56 | 19.62 |
...
|---|---:|---:|---:|
| **Ours (full)** | **90.47M** | **39.99G** | **29.81** |
| Cross-Attention | 90.50M | 45.18G | 21.21 |
| GETANet-style | 90.63M | 56.68G | 20.84 |

FPS is measured on a single RTX 3090 GPU. Compared with standard cross-attention and GETANet-style fusion, RaBiT-CC achieves a better accuracy-efficiency trade-off through mediator-based cross-modal interaction.
